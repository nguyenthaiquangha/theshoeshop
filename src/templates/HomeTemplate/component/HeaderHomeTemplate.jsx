...
import { getCartToTalQuantity } from '../../../redux/slides/Cart';
    ...
    return (
        <div>
            ...
            <nav className='header-menu'>
                ...
                {/* <NavLink className={'menu-item'} to={'/'}>Woman</NavLink>
                    <NavLink className={'menu-item'} to={'/'}>Kid</NavLink>
                    <NavLink className={'menu-item'} to={'/'}>Sport</NavLink> */}
            </nav>
        </div>
    )
}
